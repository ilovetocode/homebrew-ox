...
class Ox < Formula
  ...
  url "https://api.github.com/repos/ilovetocode/ox/releases/assets/457417970",
      using: GitHubPrivateReleaseAssetDownloadStrategy
  version "0.1.78"
  sha256 "3b1e7034ff39c66b66ad30f98bfaa833d9b8cbf92ae494308a185803111ea93a"
  ...
  test do
    assert_match "ox 0.1.78", shell_output("#{bin}/ox --version")
  end
end
