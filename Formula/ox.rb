...
class Ox < Formula
  ...
  url "https://api.github.com/repos/ilovetocode/ox/releases/assets/452275937",
      using: GitHubPrivateReleaseAssetDownloadStrategy
  version "0.1.72"
  sha256 "532cf59e731900008d57e0291c136c6d7e66ba699d5cb8f054db2048d8b86771"
  ...
  test do
    assert_match "ox 0.1.72", shell_output("#{bin}/ox --version")
  end
end
